            ...
            <div class="grid grid-cols-1 gap-10 lg:grid-cols-5 lg:items-start">
                ...
                <div class="order-2 lg:order-1 lg:col-span-3">
                    ...
                    <div class="mb-8 overflow-hidden rounded-2xl bg-gray-100 shadow-lg">
                        <img :src="donationNeed.image_url || ''" :alt="donationNeed.title" class="h-full w-full object-cover" />
                    </div>
                    ...
                    <div class="mb-6">
                        <div class="mb-3 inline-flex items-center gap-1.5 rounded-full bg-[#054A29]/10 px-3 py-1">
                            ...
                            <span class="text-xs font-semibold text-[#054A29]"
                                >Потребен износ: {{ formatAmount(donationNeed.needed_amount) }} МКД</span
                            >
                        </div>
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        <p class="mb-4 text-sm font-semibold tracking-widest text-gray-400 uppercase">За оваа потреба</p>
                        <div class="prose-content text-gray-700" v-html="donationNeed.description"></div>
                    </div>
                </div>

                <!-- Right: sticky card -->
                <div class="order-1 lg:sticky lg:top-8 lg:order-2 lg:col-span-2">
                    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                        <!-- Amount header -->
                        <div class="bg-[#054A29] px-6 py-5">
                            <p class="mb-1 text-xs font-semibold tracking-widest text-white/70 uppercase">Потребен износ</p>
                            <p class="text-3xl font-bold text-white">
                                {{ formatAmount(donationNeed.needed_amount) }}
                                <span class="text-xl font-semibold text-white/80">МКД</span>
                            </p>
                        </div>

                        <!-- Sticky rich-text content -->
                        <div v-if="donationNeed.sticky_content" class="p-6">
                            <div class="prose-content text-gray-700" v-html="donationNeed.sticky_content"></div>
                        </div>

                        <!-- Fallback note when no sticky content set -->
